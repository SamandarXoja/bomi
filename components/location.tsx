    ...
    return (
        <section id="location" className="mapSize 2xl:mt-0 xl:mt-24 lg:mt-24 md:mt-24 sm:mt-24 xs:mt-24">
            <div className="mx-auto flex flex-col justify-center items-center">
                <h2 className="mt-[60px] mb-[60px] text-[18px] uppercase text-[#333] font-semibold tracking-[2px]">наш контакт</h2>
                <iframe
            ...
            <div className="text-center">
                <h3 className="mt-[55px] text-[24px] mb-[50px]">Наша локация</h3>
                {/* <p className="font-bold">Reservation Only</p> */}
                <p className="mt-[20px] mb-[20px]">Adress: Ташкент Сити, улица Ислама Каримова.</p>
