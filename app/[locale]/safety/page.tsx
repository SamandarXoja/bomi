    ...
    return (
        <div className="flex flex-col min-h-screen"> {/* Контейнер, который занимает 100vh */}
            <div className="flex-grow"> {/* Основной контент растягивается */}
                <div className="">
                    <h2 className="text-[#333] uppercase text-safety mb-[50px]">
                    Безопасность</h2>
                    <div className="container flex justify-center gap-[50px]">
                        <div>
                            <Image className="w-[300px] h-[300px]" src={foto} alt="" />
                            <h3 className="text-center mt-[40px]">СЕЙСЕМОСТОЙКОСТЬ СИСТЕМА</h3>
                        </div>
                        <div>
                            <Image className="w-[300px] h-[300px]" src={disegner} alt="" />
                            <h3 className="text-center mt-[40px] uppercase max-w-[300px] w-full">Система для зданий, выдерживающих 9-балльные землетрясения.</h3>
                        </div>
                    </div>
                </div>
            </div>
